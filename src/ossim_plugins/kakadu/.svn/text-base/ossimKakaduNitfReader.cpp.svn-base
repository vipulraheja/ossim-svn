...
bool ossimKakaduNitfReader::allocate()
{
   ...
   if ( result && m_startOfCodestreamOffset )
   {
...
bool ossimKakaduNitfReader::scanForJpegBlockOffsets()
{
   ...
   if( hdr )
   {
      ...
      {
         //---
         // Kakadu library finds j2k tiles so this really isn't needed.  It has to
         // be implemented only because "theReadMode" is set to READ_JPEG_BLOCK.
         //---
