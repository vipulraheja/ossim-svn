...
//
//----------------------------------------------------------------------------
// $Id: ossimKakaduJp2Writer.cpp 2645 2011-05-26 15:21:34Z oscar.kramer $
...
//---
// For the "ident" program which will find all exanded $Id: ossimKakaduJp2Writer.cpp 2645 2011-05-26 15:21:34Z oscar.kramer $
// them.
//---
#if OSSIM_ID_ENABLED
static const char OSSIM_ID[] = "$Id: ossimKakaduJp2Writer.cpp 2645 2011-05-26 15:21:34Z oscar.kramer $";
#endif
...
bool ossimKakaduJp2Writer::writeGeotiffBox(ossimKakaduCompressor* compressor)
{
   ...
   if ( theInputConnection.valid() && compressor )
   {
      ...
      if ( geom.valid() )
      {
         ...
         result = compressor->writeGeotiffBox(geom.get(), rect, tmpFile);
      }
   }
