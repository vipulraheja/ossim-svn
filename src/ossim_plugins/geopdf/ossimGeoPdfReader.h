...
//
//----------------------------------------------------------------------------
// $Id: ossimGeoPdfReader.h 1251 2010-08-09 14:05:19Z david.burken $
...
private:
  ...
  std::map<ossim_int32, ossim_int32>                           frameWidthVector;
  std::map<ossim_int32, ossim_int32>                           frameHeightVector;
  ossimScalarType                                              m_scalarType;
  ossimRefPtr<ossimImageData>                                  theTile;
  
  std::map<ossimString, ossimString>                           m_podofoProjInfo;
