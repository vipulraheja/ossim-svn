...
//
//*****************************************************************************
//  $Id: ossimGdalProjectionFactory.cpp 19683 2011-05-31 14:24:10Z dburken $
#include <sstream>
...
//    ossimRefPtr<ossimImageHandler> h = new ossimGdalTileSource;
   ...
   if(h)
   {
      ...
      if ( transOk && proj==0 )
      {
         ...
         // ESH 09/2008: Check for special MrSID Metadata tag for raster type
         ...
         ossimDpt gsd(fabs(geoTransform[1]),
                      fabs(geoTransform[5]));
