...
//
//*******************************************************************
//  $Id: ossimGdalWriter.cpp 19733 2011-06-06 23:35:25Z dburken $
                                ...
                                const char* prefix)
{
   ...
   if(keys.size()>0)
   {
      ...
      {
         ossimString name    = kwl.find(keys[i] +".name");
         ossimString value   = kwl.find(keys[i] +".value");
   ...
   else
   {
      ...
      if(compressionQuality)
      {
         ...
         ossimString combine  = "QUALITY=" + ossimString(compressionQuality);
