...
#ifndef pqe_newmat_HEADER
#define pqe_newmat_HEADER 1

#include <pqe/newmatInclude.h>
#include <pqe/newmatExcept.h>
...
// being used for conversions
   ...
   class PQEDLL ArrayLengthSpecifier
   {
      int value;
   public:
...
//						// AT&T needs this
   ...
   class PQEDLL BaseMatrix : public Janitor               // base of all matrix classes
   {
   protected:
...
// ***************************** working classes **************************/
   ...
   class PQEDLL GeneralMatrix : public BaseMatrix         // declarable matrix types
   {
...
//   ReturnMatrix Reverse() const;                // reverse order of elements
   ...
   class PQEDLL Matrix : public GeneralMatrix             // usual rectangular matrix
   {
   ...
   class PQEDLL SquareMatrix : public Matrix              // square matrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
      SquareMatrix() {}
   ...
   class PQEDLL nricMatrix : public Matrix                // for use with Numerical
                             // Recipes in C
   {
      GeneralMatrix* Image() const;                // copy of matrix
   ...
   class PQEDLL SymmetricMatrix : public GeneralMatrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
   ...
   class PQEDLL UpperTriangularMatrix : public GeneralMatrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
   ...
   class PQEDLL LowerTriangularMatrix : public GeneralMatrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
   ...
   class PQEDLL DiagonalMatrix : public GeneralMatrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
...
//   ReturnMatrix Reverse() const;                // reverse order of elements
   ...
   class PQEDLL RowVector : public Matrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
   ...
   class PQEDLL ColumnVector : public Matrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
...
//   ReturnMatrix Reverse() const;                // reverse order of elements
   ...
   class PQEDLL CroutMatrix : public GeneralMatrix        // for LU decomposition
   {
      int* indx;
      bool d;
      bool sing;
...
// ***************************** band matrices ***************************/
   ...
   class PQEDLL BandMatrix : public GeneralMatrix         // band matrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   protected:
   ...
   class PQEDLL UpperBandMatrix : public BandMatrix       // upper band matrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
   ...
   class PQEDLL LowerBandMatrix : public BandMatrix       // upper band matrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
   public:
   ...
   class PQEDLL SymmetricBandMatrix : public GeneralMatrix
   {
      GeneralMatrix* Image() const;                // copy of matrix
      void CornerClear() const;                    // set unused elements to zero
      short SimpleAddOK(const GeneralMatrix* gm);
   ...
   class PQEDLL BandLUMatrix : public GeneralMatrix
...
// ************************** special matrices ****************************
   ...
   class PQEDLL IdentityMatrix : public GeneralMatrix
   {
      GeneralMatrix* Image() const;          // copy of matrix
   public:
...
// ************************** GenericMatrix class ************************/
   ...
   class PQEDLL GenericMatrix : public BaseMatrix
   {
      GeneralMatrix* gm;
...
// *************************** temporary classes *************************/
   ...
   class PQEDLL MultipliedMatrix : public BaseMatrix
   {
   protected:
   ...
   class PQEDLL AddedMatrix : public MultipliedMatrix
   {
   protected:
   ...
   class PQEDLL SPMatrix : public AddedMatrix
   {
   protected:
   ...
   class PQEDLL KPMatrix : public MultipliedMatrix
   {
   protected:
   ...
   class PQEDLL ConcatenatedMatrix : public MultipliedMatrix
   {
   protected:
   ...
   class PQEDLL StackedMatrix : public ConcatenatedMatrix
   {
   protected:
   ...
   class PQEDLL SolvedMatrix : public MultipliedMatrix
   {
   ...
   class PQEDLL SubtractedMatrix : public AddedMatrix
   {
   ...
   class PQEDLL ShiftedMatrix : public BaseMatrix
   {
   protected:
   ...
   class PQEDLL NegShiftedMatrix : public ShiftedMatrix
   {
   protected:
   ...
   class PQEDLL ScaledMatrix : public ShiftedMatrix
   {
   ...
   class PQEDLL NegatedMatrix : public BaseMatrix
   {
   protected:
      union { const BaseMatrix* bm; GeneralMatrix* gm; };
   ...
   class PQEDLL TransposedMatrix : public NegatedMatrix
   {
   ...
   class PQEDLL ReversedMatrix : public NegatedMatrix
   {
   ...
   class PQEDLL InvertedMatrix : public NegatedMatrix
   {
   ...
   class PQEDLL RowedMatrix : public NegatedMatrix
   {
   ...
   class PQEDLL ColedMatrix : public NegatedMatrix
   {
   ...
   class PQEDLL DiagedMatrix : public NegatedMatrix
   {
   ...
   class PQEDLL MatedMatrix : public NegatedMatrix
   {
      int nr, nc;
   ...
   class PQEDLL ReturnMatrix : public BaseMatrix    // for matrix return
   {
      GeneralMatrix* gm;
      int search(const BaseMatrix*) const;
   public:
...
// ************************** submatrices ******************************/
   ...
   class PQEDLL GetSubMatrix : public NegatedMatrix
   {
      int row_skip;
      int row_number;
      int col_skip;
...
// ******************** linear equation solving ****************************/
   ...
   class PQEDLL LinearEquationSolver : public BaseMatrix
   {
      GeneralMatrix* gm;
...
// ************************** matrix input *******************************/
   ...
   class PQEDLL MatrixInput // for reading a list of values into a matrix
...
// mostly intended for internal use by newmat
   ...
   class PQEDLL SimpleIntArray : public Janitor
   {
   protected:
...
// *************************** exceptions ********************************/
   ...
   class PQEDLL NPDException : public Runtime_error     // Not positive definite
   {
   public:
   ...
   class PQEDLL ConvergenceException : public Runtime_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL SingularException : public Runtime_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL OverflowException : public Runtime_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL ProgramException : public Logic_error
   {
   protected:
      ProgramException();
   public:
   ...
   class PQEDLL IndexException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL VectorException : public Logic_error    // cannot convert to vector
   {
   public:
      static unsigned long Select;          // for identifying exception
      VectorException();
   ...
   class PQEDLL NotSquareException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL SubMatrixDimensionException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL IncompatibleDimensionsException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL NotDefinedException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL CannotBuildException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
   ...
   class PQEDLL InternalException : public Logic_error
   {
   public:
      static unsigned long Select;          // for identifying exception
...
#endif /* #ifndef pqe_newmat_HEADER */
