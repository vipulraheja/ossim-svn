...
// 
//----------------------------------------------------------------------------
// $Id: ossim-tiled-elevation-test.cpp 19751 2011-06-13 15:13:07Z dburken $
...
static void usage()
{
   cout << "ossim-tiled-elevation-test <elev-dir> <input-image> <output-image>"
        << "\nCreates a ossimTiledElevationDatabase from elev-dir for the bounding box of input-image and writes output-image in tiff format." << endl;
}
