...
//
//*************************************************************************
// $Id: ossimQtSliderTableItem.h 5757 2003-12-12 19:50:32Z gpotts $
...
class QSlider;
class QWidget;
class ossimQtSliderTableItem : public QTableItem
{
public:
  ossimQtSliderTableItem(QTable * table, EditType et, const QString & text="");
