...
//
//*************************************************************************
// $Id: ossimQtPropertyColorItem.cpp 9114 2006-06-14 17:42:07Z gpotts $
#include <qhbox.h>
#include <qvariant.h>
#include <qpainter.h>
    ...
    theButton(NULL)
{
   ...
   theBox->hide();
   theColorPreview = new QFrame( theBox );
   ...
   theColorPreview->setFrameStyle( QFrame::Plain | QFrame::Box );
