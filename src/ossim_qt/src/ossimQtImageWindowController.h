...
//
//*************************************************************************
// $Id: ossimQtImageWindowController.h 15813 2009-10-25 13:33:52Z dburken $
...
public:
  ...
  virtual void editLayers();
   ...
   virtual void zoomTo(const ossimIpt& ulPt,
                       const ossimIpt& lrPt);
   virtual void zoomTo(const ossimIpt& center,
...
protected:
   ...
   /**
    * @brief Convenience method to returns image handler.
    *
    * Equivalent to:
