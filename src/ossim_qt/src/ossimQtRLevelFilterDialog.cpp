...
//
// $Id: ossimQtRLevelFilterDialog.cpp 9114 2006-06-14 17:42:07Z gpotts $
//----------------------------------------------------------------------------
     ...
     theCloseButton(NULL)
{
   ...
   theRLevelGroupBox = new QHGroupBox("current resolution level", this);
   ...
   theEnableGroupBox = new QHGroupBox("filter enabled / disabled", this);
