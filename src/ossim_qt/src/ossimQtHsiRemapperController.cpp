...
//
//*************************************************************************
// $Id: ossimQtHsiRemapperController.cpp 9114 2006-06-14 17:42:07Z gpotts $
...
#include "ossimQtHsiRemapperController.h"
...
{
   QButton* button = theDialog->theColorRangeButtonGroup->selected();
