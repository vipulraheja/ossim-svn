...
//
//*************************************************************************
// $Id: ossimQtMainWindowController.h 15766 2009-10-20 12:37:09Z gpotts $
...
public:
  ...
  virtual void openImageFileLayer();
...
public slots:
   ...
   virtual void twoColorViewCombiner();
...
protected slots:
   ...
   virtual void applyTwoColorViewCombiner(ossimConnectableObject::ConnectableObjectList& selectedObjects);
