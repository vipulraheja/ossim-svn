...
//
//----------------------------------------------------------------------------
// $Id: ossimQtBrightnessContrastDialog.cpp 9114 2006-06-14 17:42:07Z gpotts $
     ...
     theCloseButton(NULL)
{
   ...
   theBrightnessLabel->setAlignment( int( QLabel::AlignVCenter | QLabel::AlignLeft ) );
   ...
   theBrightnessSlider->setOrientation( QSlider::Horizontal );
   theBrightnessSlider->setTickmarks( QSlider::Right );
   ...
   theContrastLabel->setAlignment( int( QLabel::AlignVCenter | QLabel::AlignLeft ) );
   ...
   theContrastSlider->setOrientation( QSlider::Horizontal );
   theContrastSlider->setTickmarks( QSlider::Right );
