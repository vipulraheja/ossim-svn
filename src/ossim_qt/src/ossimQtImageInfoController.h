...
//
//*************************************************************************
// $Id: ossimQtImageInfoController.h 9114 2006-06-14 17:42:07Z gpotts $
...
private:
    ...
    */
   void updateProjectionPanel(const ossimKeywordlist& kwl);
    ...
    * @note Caller owns pointer.
    */
   ossimMapProjection* getNewMapProjection(const ossimKeywordlist& kwl) const;

   /**
    * Makes projection.
    * @note Caller owns pointer.
    */
   ossimMapProjection* getNewMapProjection(const ossimString& name) const;
