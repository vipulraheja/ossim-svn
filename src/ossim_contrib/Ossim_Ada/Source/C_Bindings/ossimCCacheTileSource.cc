...
#include "ossimCCacheTileSource.h"
...
{
	if(cache)
		delete (ossimCacheTileSource*)cache;
}

void setCachingEnabledFlag(ossimCCacheTileSourceH cache, bool flag)
{
	ossimCacheTileSource* c = (ossimCacheTileSource*) cache;
	c->setCachingEnabledFlag(flag);
}
