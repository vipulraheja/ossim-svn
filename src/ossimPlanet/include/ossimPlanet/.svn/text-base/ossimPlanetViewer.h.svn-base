...
{
public:
   class OSSIMPLANET_DLL Pager : public osgDB::DatabasePager
   {
   public:
      Pager(ossimPlanetViewer* viewer)
      :theViewer(viewer)
      {
      ...
      {
         osgDB::DatabasePager::compileGLObjects(state, availableTime);
         if(theViewer)
         {
            osg::ref_ptr<ossimPlanetTerrain> terrain = theViewer->terrainLayer();
            if(terrain.valid())
            {
               theViewer->terrainLayer()->compileGLObjects(state, availableTime);
            }
         }
      }
   protected:
...
#if 0
   class OSSIMPLANET_DLL DrawCallback : public osg::Camera::DrawCallback
   {
   public:
      DrawCallback(ossimPlanetViewer* viewer)
      :theViewer(viewer)
      {
      }
   ...
   class OSSIMPLANET_DLL Renderer : public osgViewer::Renderer
   {
   public:
      class Callback : public osg::Referenced
         {
         public:
            virtual void flushAndCompile(double /*currentElapsedFrameTime*/, 
   ...
   protected:
     virtual void flushAndCompile(double currentElapsedFrameTime, 
                                  ...
                                  osgDB::DatabasePager* databasePager, 
                                  osg::GraphicsThread* compileThread);
      osg::ref_ptr<Callback> theCallback;
   };
#endif
   ...
   {
      ossimPlanetViewer::Renderer* render = new ossimPlanetViewer::Renderer(camera);
...
protected:
#if 0
   class FlushAndCompileCallback : public ossimPlanetViewer::Renderer::Callback
   {
   public:
      FlushAndCompileCallback(ossimPlanetViewer* viewer)
      :theViewer(viewer)
      {
