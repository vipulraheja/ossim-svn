...
public:
   ...
   /**
    * @param cp Callback for the cull visitor for the moon drawable.  This will be set on to the MoonGroup node.
    *
    */
   void setMoonCullCallback(osg::ref_ptr<osg::NodeCallback> cb);
