...
#ifndef pyossimtestSingleImageChain_HEADER
#define pyossimtestSingleImageChain_HEADER 1
...
namespace pyossimtest
{
   ...
   public:
       ...
       * @note This will close previous chain if one was opened.
       */
      bool open(const std::string& file, pyossimtest_int32 entry);
       ...
       */
      std::vector<pyossimtest_int32> getEntryList() const;
       ...
       */
      bool selectBands(const std::vector<pyossimtest_uint32>& bands);
       ...
       */
      std::vector<pyossimtest_uint32> getBandSelection() const;

      /** @return Number of bands or 0 if not open. */
      pyossimtest_uint32 getNumberOfBands() const;
   ...
   private:
      ...
      bool verifyBandRange(const std::vector<pyossimtest_uint32>& bands) const;
...
#endif /* #ifndef pyossimtestSingleImageChain_HEADER */
