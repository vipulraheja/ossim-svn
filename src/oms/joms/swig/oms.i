// $Id: oms.i 19302 2011-04-07 19:55:19Z gpotts $
...
public:
   ...
   void copyToBuffer(ossim_sint16* destinationBuffer, int bandIdx)
   {
      memcpy(destinationBuffer, self->getBuf(bandIdx), self->getSizePerBandInBytes());
   }
   void copyToBuffer3(ossim_uint16* destinationBuffer, int bandIdx)
   {
      memcpy(destinationBuffer, self->getBuf(bandIdx), self->getSizePerBandInBytes());
   }
   void copyToBuffer(ossim_float32* destinationBuffer, int bandIdx)
   {
      memcpy(destinationBuffer, self->getBuf(bandIdx), self->getSizePerBandInBytes());
   }
   void copyToBuffer(ossim_float64* destinationBuffer, int bandIdx)
   {
      memcpy(destinationBuffer, self->getBuf(bandIdx), self->getSizePerBandInBytes());
   }
};
