...
MACRO(OSSIM_ADD_COMMON_LIBRARY_FLAGS)
   ...
   IF(WIN32)
     ...
     ###
     # Currently must set /FORCE:MULTIPLE for Visual Studio 2010.
     # This is actually a compiler bug so at some point we may be able to
     # turn this off.  29 October 2010 - drb
     ###
     IF(MSVC)
